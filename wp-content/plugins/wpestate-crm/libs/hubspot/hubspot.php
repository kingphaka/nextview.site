 ...
 */
 ...
 function wpestate_create_tickets_hubspot($arguments, $hubspot_api_key, $for, $who)
 {
     ...
     CURLOPT_URL => "https://api.hubapi.com/crm/v3/objects/tickets?hapikey=".$hubspot_api_key,
 ...
 */
 ...
 function wpestate_create_deal_hubspot($arguments, $hubspot_api_key, $crm_stage, $for, $who)
 {
     ...
     $curl = curl_init();
     curl_setopt_array($curl, array(
     CURLOPT_URL => "https://api.hubapi.com/crm/v3/objects/deals?hapikey=". $hubspot_api_key,
     CURLOPT_RETURNTRANSFER => true,
     CURLOPT_ENCODING => "",
     CURLOPT_MAXREDIRS => 10,
     CURLOPT_TIMEOUT => 30,
...
function wpestate_create_contact_hubspot($arguments, $lead_author_id, $who)
{
    ...
    curl_setopt_array($curl, array(
    CURLOPT_URL => "https://api.hubapi.com/crm/v3/objects/contacts?hapikey=".$hubspot_api_key_array['key'],
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
...
function wpestate_hubspot_crm_associate($fromtype, $totype, $from_id, $to_id, $hubspot_api_key)
{
    ...
    curl_setopt_array($curl, array(
    CURLOPT_URL => "https://api.hubapi.com/crm/v3/associations/".$fromtype."/".$totype."/batch/create?hapikey=".$hubspot_api_key,
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
