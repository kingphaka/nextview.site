...
class Wpresidence_Property_Page_Featured_Image extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'enable_fallback', [
            'label' => esc_html__('Enable Fallback', 'wpresidence-elementor'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'wpresidence-elementor'),
            'label_off' => esc_html__('No', 'wpresidence-elementor'),
            'return_value' => 'yes',
            'default' => ''
                ]
        );
        ...
        $this->add_control(
                'fallback_image', [
            'label' => __('Fallback Image', 'wpresidence-elementor'),
        ...
        $this->add_control(
                'text_align', [
            'label' => __('Alignment', 'wpresidence-elementor'),
            ...
            'options' => [
                'left' => [
                    'title' => __('Left', 'wpresidence-elementor'),
                    'icon' => 'fa fa-align-left',
                ],
                'center' => [
                    'title' => __('Center', 'wpresidence-elementor'),
                    'icon' => 'fa fa-align-center',
                ],
                'right' => [
                    'title' => __('Right', 'wpresidence-elementor'),
        ...
        $this->start_controls_section(
                'section_style_image', [
            'label' => __('Image', 'wpresidence-elementor'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        $this->add_responsive_control(
                'width', [
            'label' => __('Width', 'wpresidence-elementor'),
        ...
        $this->add_responsive_control(
                'space', [
            'label' => __('Max Width', 'wpresidence-elementor'),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'unit' => '%',
            ],
        ...
        $this->start_controls_tab('normal', [
            'label' => __('Normal', 'wpresidence-elementor'),
                ]
        );

        $this->add_control(
                'opacity', [
            'label' => __('Opacity', 'wpresidence-elementor'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'max' => 1,
        ...
        $this->start_controls_tab('hover', [
            'label' => __('Hover', 'wpresidence-elementor'),
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => __('Transition Duration', 'wpresidence-elementor'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'max' => 3,
        ...
        $this->add_control(
                'hover_animation', [
            'label' => __('Hover Animation', 'wpresidence-elementor'),
