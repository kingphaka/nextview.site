...
class Wpresidence_Property_Page_Subunits_Section extends Widget_Base {
    ...
    public function get_title() {
        return __('Property Page Subunits Section', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            'name' => 'box_shadow',
            'label' => esc_html__('Box Shadow', 'residence-elementor'),
            'selector' => '{{WRAPPER}} .multi_units_wrapper',
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .multi_units_wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_responsive_control(
            ...
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} .multi_units_wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .multi_units_wrapper' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        $this->add_control(
        ...
        $this->add_control(
                'unit_back_color', [
            'label' => esc_html__('Unit Background Color', 'residence-elementor'),
            'type' => Controls_Manager::COLOR,
            'default' => '',
            'selectors' => [
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .subunit_title a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'default' => '',
            'selectors' => [
                '{{WRAPPER}} .subunit_price' => 'color: {{VALUE}}',
    ...
    protected function render() {
        ...
        echo property_page_subunits_section_function($attributes, $settings);
    }
