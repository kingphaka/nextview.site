...
class Wpresidence_Property_Page_Masonary_Gallery1 extends Widget_Base {
    ...
    public function get_title() {
        return __('Property Masonary Gallery', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            'selectors' => [
                ...
                '{{WRAPPER}} 	.property_header_gallery_wrapper .col-md-3.image_gallery' => 'height: calc( {{SIZE}}{{UNIT}}/2 ) ;',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => __('Image Border', 'wpresidence-elementor'),
            'name' => 'image_border',
        ...
        $this->add_group_control(
            ...
            'label' => __('Image Shadow', 'wpresidence-elementor'),
